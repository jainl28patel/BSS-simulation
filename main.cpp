...
{
    if (this->recieved_msg.find(e.msg_id) != this->recieved_msg.end())
        return;
    bool is_msg_found = 0;
...
int main()
{
    ...
    if (error_in_input)
    {
        std::cout << "Aborted due to error in input file. Refer to output file for details\n";
        return 0;
    }
